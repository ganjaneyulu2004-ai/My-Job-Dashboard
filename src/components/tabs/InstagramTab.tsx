...
export const InstagramTab: React.FC = () => {
  ...
  const currentClientId = activeClientId === 'all' ? clients[0]?.id || 'client-1' : activeClientId;
  const currentClient = clients.find(c => c.id === currentClientId) || activeClient || clients[0];
