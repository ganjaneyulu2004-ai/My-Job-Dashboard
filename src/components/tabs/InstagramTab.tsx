                    ...
                    {post.media_url ? (
                      <button
                        onClick={() => {
                          ...
                          a.download = `instagram-media-${post.id}`;
                          document.body.appendChild(a);
                          a.click();
                          document.body.removeChild(a);
                        }}
                        className="px-2.5 py-1 rounded-lg bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-bold text-[11px] flex items-center gap-1 cursor-pointer"
                        title="Download Media File"
                      >
                        <Download className="w-3 h-3 text-emerald-600" /> Download Media
                      </button>
                    ) : <div />}
