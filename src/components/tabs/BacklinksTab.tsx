                    ...
                    {isLive && item.live_url && (
                      <div className="flex items-center gap-1.5 text-xs font-semibold text-emerald-700 pt-1">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-600 hover:text-blue-800 underline font-bold truncate flex items-center gap-1"
                        >
                          {item.live_url} <ExternalLink className="w-3 h-3 shrink-0 text-blue-500" />
                        </a>
                      </div>
                    )}
                  </div>
